export default function AnalyticsPanel({ project }) {
    ...
    return (
        <aside className="analytics-sidebar">
            <div>
                <h2 className="panel-header">Image Details</h2>
            ...
            <div>
                <h2 className="panel-header">Processing Stats</h2>
                <div className="metric-card" style={{ marginTop: '10px' }}>
                    <div className="metric-row">
                        <span>Applied Method</span>
                        <span className="metric-val" style={{ color: 'var(--brand-success)' }}>{(project?.techniqueApplied || 'NONE').replace(/_/g, ' ')}</span>
                    </div>
                    <div className="metric-row">
            ...
            <div>
                <h2 className="panel-header">Compression Stats</h2>
                <div className="metric-card" style={{ marginTop: '10px' }}>
                    <div className="metric-row">
                        <span>Compressed Image Size</span>
